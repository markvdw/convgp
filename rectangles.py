...
class RectanglesExperiment(exp_tools.ExperimentBase):
    ...
    def setup_model(self):
        ...
        if self.run_settings['kernel'] == "rbf":
            ...
            k = ckern.Conv(GPflow.kernels.RBF(9), [28, 28], [3, 3]) + GPflow.kernels.White(1, 1e-3)
        elif self.run_settings['kernel'] == "wconv":
            k = ckern.WeightedConv(GPflow.kernels.RBF(9), [28, 28], [3, 3]) + GPflow.kernels.White(1, 1e-3)
        else:
            raise NotImplementedError
